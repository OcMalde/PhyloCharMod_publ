...
def write_phylocharmod_csv(dict_id_IPPList, dict_specie_geneList, refseq_interest_list, filename) -> None:
    """
    Write a csv output file that could be use as phylocharmod input
